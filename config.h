...
static const Rule rules[] = {
	...
	{ "Chromium",  NULL,       NULL,       TAG_WEB,      0,           -1 },
	{ "firefox",   NULL,       NULL,       TAG_WEB,      0,           -1 },
	{ "mgba-sdl",  NULL,       NULL,       0,            1,           -1 },
	{ NULL,        "spterm",   NULL,       SPTAG(0),     1,           -1 },
	{ NULL,        "spcal",    NULL,       SPTAG(1),     1,           -1 },
	{ NULL,        "spkeys",   NULL,       SPTAG(2),     1,           -1 },
...
#define RSS "sfeed_dmenu blogs soft videos | plumb; pkill -RTMIN+3 status"
...
static const char *herbe1[]    = { "pkill", "-USR1", "herbe", NULL };
static const char *herbe2[]    = { "pkill", "-USR2", "herbe", NULL };
...
static const Key keys[] = {
	...
	{ ControlMask,                  XK_space,                       spawn,          {.v = herbe1 } },
	{ ControlMask|ShiftMask,        XK_space,                       spawn,          {.v = herbe2 } },
